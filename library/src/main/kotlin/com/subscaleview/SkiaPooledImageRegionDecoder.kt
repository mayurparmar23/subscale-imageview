...
class SkiaPooledImageRegionDecoder : ImageRegionDecoder {
    ...
    private fun initialiseDecoder() {
        ...
        when {
            ...
            uriString.startsWith(SubsamplingScaleImageView.Companion.FILE_SCHEME) -> {
                decoder = BitmapRegionDecoder.newInstance(uriString.substring(
                    SubsamplingScaleImageView.Companion.FILE_SCHEME.length), false)
                try {
